...
% Set untaken doses (as of serum donation day) to day 9999
...
%%%%%% dose for each study participant at each time t
...
chain.UB = [1 repmat(1,1,6) repmat(1,1,2) repmat(1,1,6) repmat(10, 1, numel(age_knots)-1)];      
...
chain_7delay.UB = [1 repmat(1,1,6) repmat(1,1,2) repmat(1,1,6) repmat(10, 1, numel(age_knots)-1)];      
...
chain_14delay.UB = [1 repmat(1,1,6) repmat(1,1,2) repmat(1,1,6) repmat(10, 1, numel(age_knots)-1)];      

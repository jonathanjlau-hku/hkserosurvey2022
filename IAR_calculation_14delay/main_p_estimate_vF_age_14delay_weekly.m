...
load("sampled_posteriors_14delay_age.mat");
sampled_posteriors = sampled_posteriors_14delay;
...
save ("14_delay_age_weekly.mat","proxy","-v7.3","-nocompression")
m = matfile("14_delay_age_weekly.mat","writable",true);
...
parfor ii = 1:proxyWeekLength
    ...
    for jj = 1:no_scenarios
        ...
        temp_immunity_malato_all(jj) = mean(immunity_barnard_iter);
...
writematrix([reshape(p_infection_weekly_cohort(kk,:,:),[6 proxyWeekLength])' repmat(age_cohorts(kk),proxyWeekLength,1) repmat("14 day delay",proxyWeekLength,1) repmat("IAR",proxyWeekLength,1)],strcat("p_infection_weekly_14delay_",age_cohorts(kk),".csv"));
writematrix([reshape(immunity_weekly_cohort(kk,:,:),[6 proxyWeekLength])' repmat(age_cohorts(kk),proxyWeekLength,1) repmat("14 day delay",proxyWeekLength,1) repmat("Pop immunity",proxyWeekLength,1)],strcat("immunity_weekly_14delay_",age_cohorts(kk),".csv"));
writematrix([reshape(immunity_barnard_weekly_cohort(kk,:,:),[6 proxyWeekLength])' repmat(age_cohorts(kk),proxyWeekLength,1) repmat("14 day delay",proxyWeekLength,1) repmat("Pop immunity (Scenario 1)",proxyWeekLength,1)],strcat("immunity_weekly_14delay_1_",age_cohorts(kk),".csv"));
writematrix([reshape(immunity_malato_weekly_cohort(kk,:,:),[6 proxyWeekLength])' repmat(age_cohorts(kk),proxyWeekLength,1) repmat("14 day delay",proxyWeekLength,1) repmat("Pop immunity (Scenario 2)",proxyWeekLength,1)],strcat("immunity_weekly_14delay_2_",age_cohorts(kk),".csv"));



end

writematrix([reshape(p_infection_weekly_all,[6 proxyWeekLength])' repmat("all",proxyWeekLength,1) repmat("14 day delay",proxyWeekLength,1) repmat("IAR",proxyWeekLength,1)],"p_infection_weekly_14delay_all.csv")
writematrix([reshape(immunity_weekly_all,[6 proxyWeekLength])' repmat("all",proxyWeekLength,1) repmat("14 day delay",proxyWeekLength,1) repmat("Pop immunity",proxyWeekLength,1)],"immunity_weekly_14delay_all.csv")
writematrix([reshape(immunity_barnard_weekly_all,[6 proxyWeekLength])' repmat("all",proxyWeekLength,1) repmat("14 day delay",proxyWeekLength,1) repmat("Pop immunity (Scenario 1)",proxyWeekLength,1)],"immunity_weekly_14delay_1_all.csv")
writematrix([reshape(immunity_malato_weekly_all,[6 proxyWeekLength])' repmat("all",proxyWeekLength,1) repmat("14 day delay",proxyWeekLength,1) repmat("Pop immunity (Scenario 2)",proxyWeekLength,1)],"immunity_weekly_14delay_2_all.csv")

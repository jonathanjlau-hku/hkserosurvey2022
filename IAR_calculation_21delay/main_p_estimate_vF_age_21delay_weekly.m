...
% effect with a 21 day delay and given no waning of infection-acquired
...
load("sampled_posteriors_21delay_age.mat");
sampled_posteriors = sampled_posteriors_21delay;
...
save ("21_delay_age_weekly.mat","proxy","-v7.3","-nocompression")
m = matfile("21_delay_age_weekly - Copy.mat","writable",true);
...
writematrix([reshape(p_infection_weekly_cohort(kk,:,:),[6 proxyWeekLength])' repmat(age_cohorts(kk),proxyWeekLength,1) repmat("21 day delay",proxyWeekLength,1) repmat("IAR",proxyWeekLength,1)],strcat("p_infection_weekly_21delay_",age_cohorts(kk),".csv"));
writematrix([reshape(immunity_weekly_cohort(kk,:,:),[6 proxyWeekLength])' repmat(age_cohorts(kk),proxyWeekLength,1) repmat("21 day delay",proxyWeekLength,1) repmat("Pop immunity",proxyWeekLength,1)],strcat("immunity_weekly_21delay_",age_cohorts(kk),".csv"));
writematrix([reshape(immunity_barnard_weekly_cohort(kk,:,:),[6 proxyWeekLength])' repmat(age_cohorts(kk),proxyWeekLength,1) repmat("21 day delay",proxyWeekLength,1) repmat("Pop immunity (Scenario 1)",proxyWeekLength,1)],strcat("immunity_weekly_21delay_1_",age_cohorts(kk),".csv"));
writematrix([reshape(immunity_malato_weekly_cohort(kk,:,:),[6 proxyWeekLength])' repmat(age_cohorts(kk),proxyWeekLength,1) repmat("21 day delay",proxyWeekLength,1) repmat("Pop immunity (Scenario 2)",proxyWeekLength,1)],strcat("immunity_weekly_21delay_2_",age_cohorts(kk),".csv"));



end

writematrix([reshape(p_infection_weekly_all,[6 proxyWeekLength])' repmat("all",proxyWeekLength,1) repmat("21 day delay",proxyWeekLength,1) repmat("IAR",proxyWeekLength,1)],"p_infection_weekly_21delay_all.csv")
writematrix([reshape(immunity_weekly_all,[6 proxyWeekLength])' repmat("all",proxyWeekLength,1) repmat("21 day delay",proxyWeekLength,1) repmat("Pop immunity",proxyWeekLength,1)],"immunity_weekly_21delay_all.csv")
writematrix([reshape(immunity_barnard_weekly_all,[6 proxyWeekLength])' repmat("all",proxyWeekLength,1) repmat("21 day delay",proxyWeekLength,1) repmat("Pop immunity (Scenario 1)",proxyWeekLength,1)],"immunity_weekly_21delay_1_all.csv")
writematrix([reshape(immunity_malato_weekly_all,[6 proxyWeekLength])' repmat("all",proxyWeekLength,1) repmat("21 day delay",proxyWeekLength,1) repmat("Pop immunity (Scenario 2)",proxyWeekLength,1)],"immunity_weekly_21delay_2_all.csv")

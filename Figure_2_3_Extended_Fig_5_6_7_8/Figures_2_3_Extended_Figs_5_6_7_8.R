...
## Purpose: To create Figure 2, Figure 3, and Extended data Figures 5, 6, 7 and 8
...
# IAR plot by age group (Fig 2 Panel B)
...
# Population immunity plot by age group (Fig 2 Panel C) (no waning)
...
# Ascertainment rate (overall) plot (Fig 2 Panel D)
...
# IAR plot over time (all ages) (Figure 3 Panel A)
...
# Population immunity plot over time (all ages) (no waning) (Figure 3 Panel B)
...
# Population immunity plot over time (by age group) (no waning) (Extended Figure 6)
...
# Population immunity plot over time (all ages) (15% waning in 365 days) (Figure 3 Panel C) following [15] Barnard et al
...
# Population immunity plot over time (by age group) (15% waning in 365 days) (Extended Data Figure 7) following [15] Barnard et al
...
# Population immunity plot over time (all ages) (25% waning in 100 days) (Figure 3 Panel D) following [16] Malato et al and [17] Altarawneh et al
...
# Population immunity plot over time (by age group) (25% waning in 100 days) (Extended Data Figure 8) following [16] Malato et al and [17] Altarawneh et al
...
iar_imm_plot <- align_plots(iar_plot+theme(legend.position="none",axis.text.x = element_text(size=8),axis.text.y=element_text(size=10),axis.title.x = element_blank(),axis.title.y = element_text(size=12)),
                            ...
                            imm_barnard_plot+theme(legend.position="none",axis.text.x = element_text(size=8),axis.text.y=element_text(size=10),axis.title.x = element_blank(),axis.title.y = element_text(size=12)),
                            imm_malato_plot+theme(legend.position="none",axis.text.x = element_text(size=8),axis.text.y=element_text(size=10),axis.title.x = element_blank(),axis.title.y = element_text(size=12)),
                            align="h",axis="lr",greedy=TRUE)

iar_imm_plot_with_labels <- plot_grid(iar_imm_plot[[1]],iar_imm_plot[[2]],iar_imm_plot[[3]],iar_imm_plot[[4]],nrow=1,labels=c("A","B","C","D"),label_y = c(1,1))
...
iar_imm_cumu_plot_with_labels <- plot_grid(iar_imm_cumu_plot[[1]],iar_imm_cumu_plot[[2]],ncol=1,labels=c("B","C"),label_y = c(1,1))
...
ar_all_plots <- align_plots(ar_plot+theme(legend.position="none", axis.text.x = element_text(size=8),axis.text.y=element_text(size=10),axis.title.x = element_blank(),axis.title.y = element_text(size=12)),
                            ...
                            align="v",axis="lr")
ar_all_plots_with_labels <- plot_grid(ar_all_plots[[1]],ar_all_plots[[2]],ncol=1,labels=c("D","E"),label_y=c(1, 1))
...
VE_iar_imm_cumu_ar_plot <- plot_grid(VE_plot+theme(legend.position="none"),
                                     iar_imm_cumu_plot_with_labels,ar_all_plots_with_labels,
                                     nrow=1,labels=c("A",""))

full_plot_figure_2 <- plot_grid(
...
full_plot_figure_3 <- plot_grid(
  iar_imm_plot_with_labels+theme(axis.title.x = element_text(size=12),axis.title.y = element_text(size=12)),
  legend_VE,
  ncol = 1,
  # rel_heights values control vertical title margins
  rel_heights = c(1, 0.1))
...
ggsave(file = "Figure_2.tiff",full_plot_figure_2,width=15,height=6,dpi=1000,compression="lzw")
...
ggsave(file = "Figure_3.tiff",full_plot_figure_3,width=15,height=5,dpi=1000,compression="lzw")

ggsave(file = "Extended_Figure_7.tiff",imm_barnard_plot_facet,height=9,width=6,dpi=1000,compression="lzw")
ggsave(file = "Extended_Figure_8.tiff",imm_malato_plot_facet,height=9,width=6,dpi=1000,compression="lzw")